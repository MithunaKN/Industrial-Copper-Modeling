...
add_bg_from_local('copper_image.jpg')
# OPTION MENU
with st.sidebar:
...
if selected == "PREDICT SELLING PRICE":
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\rmodel.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\rscaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\rt.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\rs.pkl", 'rb') as f:
...
if selected == "PREDICT STATUS":
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\MITHUNA\OneDrive\Desktop\Mithu\ct.pkl", 'rb') as f:
        ...
        if new_pred == 1:
            st.write('## :green[The Status is Won]' + thumbs_up)
        else:
            st.write('## :red[The status is Lost]' + thumbs_down)
